...
<h1><?php _e('Upload Your Cover','users-control')?></h1>
		   ...
		   if( $crop_image=='crop_image') //displays image cropper
			{
             ...
             <div class="userscontrol-staff-right-avatar " >
           		  <div class="pr_tipb_be">
                            ...
                            <?php 
                            echo $userscontrol->profile->display_cover_image_to_crop($image_to_crop, $user_id);
                            ?>                          
            ...
            <div class="userscontrol-staff-right-avatar " >
                   ...
                   <h3> <?php echo esc_attr($user->display_name)?><?php _e("'s Picture",'users-control')?></h3>
                             ...
                             <?php echo wp_kses($userscontrol->profile->get_profile_bg( $user_id), $userscontrol->allowed_html); ?>

                                                    
                             <div class="uu-upload-avatar-sect">
                              
                                     <?php echo $userscontrol->profile->profile_cover_uploader($user_id);
